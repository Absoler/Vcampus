...
public class CourseDeleteGUI extends JPanel{
	...
	JLabel lWelcome1 = new JLabel("★☆★☆欢迎来到退课系统☆★☆★");
	JLabel lWelcome2 = new JLabel("按下选课按钮即可退课！");
	JLabel lWelcome3 = new JLabel("注意：未选课程不能退课，要好好学习、谨慎退课哦。");
...
//	}
	...
	public CourseDeleteGUI(Student u, ArrayList<Course> c,Image image)
	{
		this.image = image;
...
//		}
//		this.setBorder(BorderFactory.createTitledBorder("退课"));
...
//		lWelcome3.setFont(font1);
		...
		JLabel title = new JLabel("| 学生选退课系统");
                ...
                case 3: 
                    ...
                    button.addActionListener(new ActionListener() {
                        public void actionPerformed(ActionEvent arg0) {
                        	...
                        	mes.setMessageType(Constants.course_delete);
                        	...
                        	if(serverResponse.isLastOperState()) {
                        		JOptionPane.showMessageDialog(null, "退课成功！要好好学习哦。");
                        	}
                        	else {
